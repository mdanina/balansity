                ...
                <div className="px-4 md:px-0">
                  ...
                  <div className="space-y-4 mb-6">
                    <p className="text-base text-white/90">
                      Наталья Владимировна Кисельникова — соучредитель и директор по стратегии Balansity, кандидат психологических наук, психолог-исследователь с более чем 15-летним опытом руководства междисциплинарными проектами в сфере психического здоровья.
                    </p>
                    <p className="text-base text-white/90">
