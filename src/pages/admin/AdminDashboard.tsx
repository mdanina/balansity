    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Оплаченные отчеты</CardTitle>
              <CreditCard className="h-4 w-4 text-muted-foreground" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold">{metrics.assessments.paid}</div>
              <p className="text-xs text-muted-foreground">
                {metrics.assessments.completed > 0
                  ? Math.round((metrics.assessments.paid / metrics.assessments.completed) * 100)
                  : 0}
                % от завершенных
              </p>
            </CardContent>
