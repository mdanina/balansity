            ...
            <Card className="bg-blue-50 border-blue-200">
              <CardContent className="pt-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-medium text-blue-900">Как работает AI-анализ</h3>
                    <p className="text-sm text-blue-700 mt-1">
                      1. Выберите шаблон заметки<br />
                      2. Добавьте транскрипт сессии или свои заметки<br />
                      3. Нажмите "Создать клиническую заметку"<br />
                      4. AI сгенерирует содержимое по каждой секции<br />
                      5. Отредактируйте при необходимости и сохраните
                    </p>
                  </div>
                </div>
              </CardContent>
