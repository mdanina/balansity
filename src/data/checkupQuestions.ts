...
export const checkupQuestions: Question[] = [
  ...
  { id: 4, text: "Мой ребенок нервный или цепляется в новых ситуациях", category: "О ребенке", answerType: 'default' },
  ...
  { id: 13, text: "Мой ребенок легко отвлекается, трудно удержать внимание", category: "О ребенке", answerType: 'default' },
