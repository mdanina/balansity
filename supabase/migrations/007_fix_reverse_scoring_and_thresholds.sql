-- ============================================
-- Исправление reverse scoring и порогов для РФ
-- Reverse scoring теперь применяется ПРИ СОХРАНЕНИИ в базу данных
-- Поэтому функция подсчета просто суммирует значения
-- ============================================

-- Обновляем функцию calculate_checkup_scores
-- Теперь reverse scoring уже применен при сохранении, поэтому просто суммируем
